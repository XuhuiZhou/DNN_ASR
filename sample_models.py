...
def cnn_rnn_model(input_dim, filters, kernel_size, conv_stride,
    ...
    # TODO: Add batch normalization
    bn_rnn = BatchNormalization(name='bn_rnn_1d')(conv_1d)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
    time_dense = TimeDistributed(Dense(output_dim))(bn_rnn)
    # Add softmax activation layer
    y_pred = Activation('softmax', name='softmax')(time_dense)
...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
    	simp_rnn = GRU(units, activation='relu',
    		return_sequences=True, implementation=2, name="rnn_{}".format(i))(input_layer)
    	# TODO: Add batch normalization 
...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn = bidir_rnn = Bidirectional(GRU(units, 
...
def final_model(input_dim,units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
        bidir_rnn = Bidirectional(GRU(units, return_sequences=True, implementation=2, 
        	name='bidir_rnn_{}'.format(i)))(prev_input)
        batch_norm = BatchNormalization(name="bn_{}".format(i))(bidir_rnn)
